...
namespace heros.utilities
{
	...
	public abstract class Edge<Fact>
    {
		...
		public class NormalEdge : Edge<Fact>
		{
			...
			public override void accept(EdgeVisitor visitor)
			{
				visitor.visit(this);
			}
		}

		public class CallEdge : Edge<Fact>
		{
		...
		public class Call2ReturnEdge : Edge<Fact>
		{
			public readonly Statement callSite;
		...
		public class ReturnEdge : Edge<Fact>
        {
